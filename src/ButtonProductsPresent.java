...
public class ButtonProductsPresent extends CoreTestCase {
    ...
    public void testSearchPopup() {
        ...
        mainPageObject.waitForElementAndClick(
                By.xpath("//*[@contentDescription='Продукты' and @class='android.widget.ImageButton']"),
        ...
        assertTrue("Не удалось найти заголовок 'Продукты'", mainPageObject.isElementPresent(By.xpath("//*[@text='Продукты' and (./preceding-sibling::* | ./following-sibling::*)[@id='buttonRound']]")));
